...
// USER ACTION REQUIRED: update cmd/manager/main.go to call this daemonset.Add(mgr) to install this Controller
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &daemonsetv1beta1.Job{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &appsv1.Deployment{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &daemonsetv1beta1.Job{},
	})
	if err != nil {
		return err
	}
...
// +kubebuilder:rbac:groups=daemonset.darkowlzz.space,resources=jobs,verbs=get;list;watch;create;update;patch;delete
func (r *ReconcileJob) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	// Fetch the Job instance
	instance := &daemonsetv1beta1.Job{}
	...
	deploy := &appsv1beta2.DaemonSet{
		ObjectMeta: metav1.ObjectMeta{
			Name:      instance.Name + "-daemonset-job",
			Namespace: instance.Namespace,
		},
		Spec: appsv1beta2.DaemonSetSpec{
			Selector: &metav1.LabelSelector{
				MatchLabels: map[string]string{"daemonset": instance.Name + "-daemonset-job"},
			},
			Template: corev1.PodTemplateSpec{
				ObjectMeta: metav1.ObjectMeta{
					Labels: map[string]string{"daemonset": instance.Name + "-daemonset-job"},
				},
				Spec: corev1.PodSpec{
